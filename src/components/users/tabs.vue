<template>
    <ul class="nav nav-tabs nav-tabs-simple nav-tabs-left bg-white">
        ...
        <li class="nav-item">
            <router-link :to="{ name: 'settingsUsersSecurity' }" :class="{active: $route.name == 'settingsUsersSecurity'}">Security</router-link>
        </li>
        <li class="nav-item">
            <router-link :to="{ name: 'settingsUsersDevices' }" :class="{active: $route.name == 'settingsUsersDevices'}">Devices</router-link>
        </li>
    </ul>
</template>
